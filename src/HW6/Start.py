...
def run_tests():
    func_pass= 0
    test_suite = [test_nums, test_sym,test_the, test_some, test_half, test_csv, test_data,  test_clone, test_cliffs, test_tree,  test_dist, test_csv, test_sway, test_bins, test_explain] 
